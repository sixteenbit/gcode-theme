	...
	class GT_Customizer {
		...
		public static function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'settings'    => 'text_color',
						'section'     => 'colors',
						'label'       => __( 'Text Color', 'gcode-theme' ),
						'description' => __( 'Select the color to be used for the body text color.', 'gcode-theme' ),
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						...
						'section'     => 'colors',
						'label'       => __( 'Header Background', 'gcode-theme' ),
						'description' => __( 'Select the background color to be used for the header.', 'gcode-theme' ),
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						...
						'section'     => 'colors',
						'label'       => __( 'Header Color', 'gcode-theme' ),
						'description' => __( 'Select the color to be used for the header menu items.', 'gcode-theme' ),
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						...
						'section'     => 'colors',
						'label'       => __( 'Anchor Color', 'gcode-theme' ),
						'description' => __( 'Select the color to be used for hyperlink color.', 'gcode-theme' ),
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						...
						'section'     => 'colors',
						'label'       => __( 'Anchor Hover Color', 'gcode-theme' ),
						'description' => __( 'Select the color to be used for hyperlink hover color.', 'gcode-theme' ),
					)
				)
			);
			...
			$wp_customize->add_section(
				'theme_options',
				array(
					'title'    => esc_html__( 'Theme Options', 'gcode-theme' ),
					'priority' => 190,
				)
			);
			...
			if ( ! function_exists( 'v_forcelogin' ) ) {
				...
				$wp_customize->add_control(
					'force_login',
					array(
						'label'       => esc_html__( 'Force Login', 'gcode-theme' ),
						'description' => esc_html__( 'Make the website private until it\'s ready to share publicly, or keep it private for members only.', 'gcode-theme' ),
